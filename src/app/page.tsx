...
export default async function HomePage() {
  ...
  const contestsWithFormattedStart = contests?.map(c => ({
    ...c,
    formattedStartIST: parseAsUTC(c.start).toLocaleString('en-IN', {
      year: 'numeric',
      month: 'long',
      day: 'numeric',
      hour: '2-digit',
    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      <div className="container mx-auto p-4 md:p-8">
        ...
        {error ? (
          ...
          <ContestClientComponent initialContests={contestsWithFormattedStart || []} />
        )}
